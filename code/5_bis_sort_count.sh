...
echo "2137"
echo "##############################"
python3 expr_count.py ${path_to_gff}/archaea/bin_1/bin_1.gff ${path_to_out}/bin_1_count_2137.out
echo "##############################"
echo "2139"
echo "##############################"
python3 expr_count.py ${path_to_gff}/archaea/bin_1/bin_1.gff ${path_to_out}/bin_1_count_2139.out
